Shader "Miscellaneous/Dissolve_Shader"
{
	Properties{
	...
	SubShader{
		...
		/*
			By default opaque surface shaders write 1.0 (white) into alpha channel, 
			no matter what’s output in the Alpha of output struct or what’s returned by 
			the lighting function. Using this option allows keeping lighting function’s alpha 
			value even for opaque surface shaders.
		*/
		...
		#pragma lighting ToonRamp exclude_path:prepass // do not generate path (prepass)
		...
		void surf(Input IN, inout SurfaceOutput o) {
			...
			// this indicates how much the edge transparency, determined by how far away it is from colored edge.
			float factor = 1 - (_DisAmount - (n.r - _DisLineWidth)) / _DisLineWidth;
