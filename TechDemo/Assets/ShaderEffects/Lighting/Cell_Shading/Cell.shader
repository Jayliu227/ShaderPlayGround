    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float LightToonShading(float3 normal, float3 lightDir)
            {
                ...
                // the bigger the threshold, the smaller the interval
                // since the numerator has been multipled by 5, the range has exceeded 0 to 1
                // so we need to map it back to 0,1 by dividing itself by the threshold. (0.5 here only helps brighten the object)
